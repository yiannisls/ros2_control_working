...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, control_msgs, action, JointTrajectory_SendGoal)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<control_msgs::action::JointTrajectory_SendGoal>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, control_msgs, action, JointTrajectory_GetResult)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<control_msgs::action::JointTrajectory_GetResult>();
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_action_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__ACTION_SYMBOL_NAME(rosidl_typesupport_cpp, control_msgs, action, JointTrajectory)() {
  return ::rosidl_typesupport_cpp::get_action_type_support_handle<control_msgs::action::JointTrajectory>();
}
