...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, control_msgs, srv, QueryCalibrationState)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<control_msgs::srv::QueryCalibrationState>();
}
