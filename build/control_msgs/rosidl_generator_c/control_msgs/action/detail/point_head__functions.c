  ...
  control_msgs__action__PointHead_Goal__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__PointHead_Goal * data =
      (control_msgs__action__PointHead_Goal *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__PointHead_Goal__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          control_msgs__action__PointHead_Goal__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  control_msgs__action__PointHead_Result__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__PointHead_Result * data =
      (control_msgs__action__PointHead_Result *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__PointHead_Result__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          control_msgs__action__PointHead_Result__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  control_msgs__action__PointHead_Feedback__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__PointHead_Feedback * data =
      (control_msgs__action__PointHead_Feedback *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__PointHead_Feedback__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          control_msgs__action__PointHead_Feedback__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  control_msgs__action__PointHead_SendGoal_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__PointHead_SendGoal_Request * data =
      (control_msgs__action__PointHead_SendGoal_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__PointHead_SendGoal_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          control_msgs__action__PointHead_SendGoal_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  control_msgs__action__PointHead_SendGoal_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__PointHead_SendGoal_Response * data =
      (control_msgs__action__PointHead_SendGoal_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__PointHead_SendGoal_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          control_msgs__action__PointHead_SendGoal_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  control_msgs__action__PointHead_GetResult_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__PointHead_GetResult_Request * data =
      (control_msgs__action__PointHead_GetResult_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__PointHead_GetResult_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          control_msgs__action__PointHead_GetResult_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  control_msgs__action__PointHead_GetResult_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__PointHead_GetResult_Response * data =
      (control_msgs__action__PointHead_GetResult_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__PointHead_GetResult_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          control_msgs__action__PointHead_GetResult_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  control_msgs__action__PointHead_FeedbackMessage__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    control_msgs__action__PointHead_FeedbackMessage * data =
      (control_msgs__action__PointHead_FeedbackMessage *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!control_msgs__action__PointHead_FeedbackMessage__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          control_msgs__action__PointHead_FeedbackMessage__fini(&data[i]);
        }
        free(data);
        return false;
      }
