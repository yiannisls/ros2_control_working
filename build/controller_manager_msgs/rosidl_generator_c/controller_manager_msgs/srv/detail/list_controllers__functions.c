  ...
  controller_manager_msgs__srv__ListControllers_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    controller_manager_msgs__srv__ListControllers_Request * data =
      (controller_manager_msgs__srv__ListControllers_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!controller_manager_msgs__srv__ListControllers_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          controller_manager_msgs__srv__ListControllers_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  controller_manager_msgs__srv__ListControllers_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    controller_manager_msgs__srv__ListControllers_Response * data =
      (controller_manager_msgs__srv__ListControllers_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!controller_manager_msgs__srv__ListControllers_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          controller_manager_msgs__srv__ListControllers_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
