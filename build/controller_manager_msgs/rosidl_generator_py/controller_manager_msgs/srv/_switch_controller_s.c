...
bool controller_manager_msgs__srv__switch_controller__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // start_controllers
    PyObject * field = PyObject_GetAttrString(_pymsg, "start_controllers");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'start_controllers'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->start_controllers.data;
  ...
  {  // stop_controllers
    PyObject * field = PyObject_GetAttrString(_pymsg, "stop_controllers");
    if (!field) {
      return false;
    }
    {
      PyObject * seq_field = PySequence_Fast(field, "expected a sequence in 'stop_controllers'");
      if (!seq_field) {
        Py_DECREF(field);
        return false;
      }
      ...
      rosidl_runtime_c__String * dest = ros_message->stop_controllers.data;
      for (Py_ssize_t i = 0; i < size; ++i) {
        PyObject * item = PySequence_Fast_GET_ITEM(seq_field, i);
        if (!item) {
          Py_DECREF(seq_field);
  ...
  {  // start_asap
    PyObject * field = PyObject_GetAttrString(_pymsg, "start_asap");
    if (!field) {
      return false;
    }
    assert(PyBool_Check(field));
    ros_message->start_asap = (Py_True == field);
    Py_DECREF(field);
  }
  {  // timeout
...
PyObject * controller_manager_msgs__srv__switch_controller__request__convert_to_py(void * raw_ros_message)
{
  ...
  {  // start_controllers
    ...
    rosidl_runtime_c__String * src = ros_message->start_controllers.data;
    ...
    {
      int rc = PyObject_SetAttrString(_pymessage, "start_controllers", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // stop_controllers
    ...
    rosidl_runtime_c__String * src = ros_message->stop_controllers.data;
    field = PyList_New(size);
    if (!field) {
      return NULL;
    }
    ...
    assert(PySequence_Check(field));
    {
      int rc = PyObject_SetAttrString(_pymessage, "stop_controllers", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
  ...
  {  // start_asap
    PyObject * field = NULL;
    field = PyBool_FromLong(ros_message->start_asap ? 1 : 0);
    {
      int rc = PyObject_SetAttrString(_pymessage, "start_asap", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
